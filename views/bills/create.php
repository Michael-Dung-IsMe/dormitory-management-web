<?php
$pageTitle = 'Lập Hóa đơn Điện Nước';
...
<div class="card" style="max-width: 800px; margin: 0 auto;">
    ...
    <form action="/bill/create" method="POST" class="custom-form">
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <div class="d-flex gap-10">
                    <select name="billing_month" class="form-control" required>
                        <?php for($i=1; $i<=12; $i++): ?>
                            <option value="<?php echo $i; ?>" <?php echo (date('n') == $i) ? 'selected' : ''; ?>>Tháng <?php echo $i; ?></option>
                        <?php endfor; ?>
                    </select>
                    <input type="number" name="billing_year" class="form-control" required value="<?php echo date('Y'); ?>">
                </div>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="number" name="old_electric_index" class="form-control" required value="0">
            </div>
            <div class="form-group">
                <label>Chỉ số Mới <span class="text-danger">*</span></label>
                <input type="number" name="new_electric_index" class="form-control" required value="0">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                <label>Chỉ số Cũ <span class="text-danger">*</span></label>
                <input type="number" name="old_water_index" class="form-control" required value="0">
            </div>
            <div class="form-group">
                <label>Chỉ số Mới <span class="text-danger">*</span></label>
                <input type="number" name="new_water_index" class="form-control" required value="0">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="number" name="room_fee" class="form-control" value="0">
            </div>
            <div class="form-group">
        ...
        <div class="form-actions text-right mt-4">
            <button type="submit" class="btn btn-primary"><i class="fa-solid fa-calculator"></i> Tính & Lưu Hóa Đơn</button>
        </div>
    </form>
</div>
